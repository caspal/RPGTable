...
public class RPGTableConfig {
    ...
    public static class RPGTableConfigOptions {
        ...
        public final static int BODY_SIZE_LIMIT_DEFAULT = 1024 * 1024 * 10; // 10 mebibyte
        ...
        @VisibleForTesting
        public static RPGTableConfigOptions defaults() {
        ...
        public RPGTableConfigOptions setBodySizeLimitBytes(int bodySizeLimitBytes) {
            config.put(BODY_SIZE_LIMIT_BYTES_KEY, bodySizeLimitBytes);
            return this;
        }
    }
    ...
    private final static Set<String> KEYS = ImmutableSet.of(WORKSPACE_DIR_KEY, HTTP_PORT_KEY, BODY_SIZE_LIMIT_BYTES_KEY,
            ENV_TEST_KEY);

    private final RPGTableConfigOptions options;

    @VisibleForTesting
    public RPGTableConfig(RPGTableConfigOptions options) {
