...
public class MediaTypeDetector {
    ...
    private static MediaTypeDetector instance;;

    private MediaTypeDetector(Vertx vertx) {
        this.vertx = vertx;
    }

    public static MediaTypeDetector getInstance(Vertx vertx) {
        if (Objects.isNull(instance)) {
            instance = new MediaTypeDetector(vertx);
        }
        return instance;
    }
