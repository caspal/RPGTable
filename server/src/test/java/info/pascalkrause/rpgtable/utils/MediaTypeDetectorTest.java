...
public class MediaTypeDetectorTest {
    ...
    public void detect_image_gif() throws IOException {
        assertThat(MediaTypeDetector.detectBlocking(TestUtils.readFile("images/TestImage.gif"))).isEqualTo(MediaType.GIF);
    }

    @Test
    public void detect_image_jpeg() throws IOException {
        assertThat(MediaTypeDetector.detectBlocking(TestUtils.readFile("images/TestImage.jpeg"))).isEqualTo(MediaType.JPEG);
    }

    @Test
    public void detect_image_png() throws IOException {
        assertThat(MediaTypeDetector.detectBlocking(TestUtils.readFile("images/TestImage.png"))).isEqualTo(MediaType.PNG);
    }
    ...
    public void detect_image_svg() throws IOException {
        assertThat(MediaTypeDetector.detectBlocking(TestUtils.readFile("images/svg.svg"))).isEqualTo(MediaType.SVG_UTF_8);
    }
}