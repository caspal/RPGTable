...
public class RouterVerticleTest {
     ...
     * <p/>
     * This method instantiates a new Vertx and deploys the verticle. Then, it waits to see if the verticle has
     * successfully completed its start sequence (thanks to `context.asyncAssertSuccess`).
     *
